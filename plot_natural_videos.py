...
resource_files = [os.path.join(bg_path, f) for f in os.listdir(bg_path) if os.path.isfile(os.path.join(bg_path, f))]
env = wrappers.DeepMindControl(
    task, size, resource_files=resource_files, img_source=img_source_type, random_bg=random_bg
)
